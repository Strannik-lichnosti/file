...
local speech = {
	ACTIONFAIL =
	{
        ...
        {
            GENERIC = "Нет не могу ...",
            TOOFAR = "Я должна подойти ближе.",
        },
        GIVE =
        {
            DEAD = "Я должна оставить это позади.",
            SLEEPING = "Я засыпаю...",
	...
	ANNOUNCE_ADVENTUREFAIL = "В следующий раз я не проиграю!",
	ANNOUNCE_BEES = "Пчелка",
	ANNOUNCE_BOOMERANG = "Будьте готовы к его возвращению.",
	ANNOUNCE_CHARLIE = "Что это...???",
	ANNOUNCE_CHARLIE_ATTACK = "Чарли???",
	ANNOUNCE_COLD = "Драконы тоже боятся холода.",
	ANNOUNCE_HOT = "Драконы тоже не терпят жара.",
	ANNOUNCE_CRAFTING_FAIL = "Мне не хватает некоторых ключевых материалов.",
	ANNOUNCE_DEERCLOPS = "В моем мире были похожие существа",
	...
	ANNOUNCE_HOUNDS = "Они идут за мной",
	ANNOUNCE_WORMS = "Я чувствую кого-то под ногами",
	...
	ANNOUNCE_NODANGERSLEEP = "Спи спокойно!",
	...
	ANNOUNCE_NOSLEEPONFIRE = "Это будет горячая ночь",
	ANNOUNCE_NODANGERSIESTA = "Спи спокойно!",
	ANNOUNCE_NONIGHTSIESTA = "Место для обеда.",
	ANNOUNCE_NONIGHTSIESTA_CAVE = "Я не думаю, что это хорошее место для обеда.",
	...
	ANNOUNCE_TOOL_SLIP = "Ой, он скользкий!",
	ANNOUNCE_LIGHTNING_DAMAGE_AVOIDED = "В безопасности от страшной молнии!",

	ANNOUNCE_DAMP = "Очень мокрый",
	ANNOUNCE_WET = "Моя одежда промокла",
	ANNOUNCE_WETTER = "Я ненавижу воду",
	ANNOUNCE_SOAKED = "Я не люблю мокнуть...",

	ANNOUNCE_TREASURE = "Я чувствую себя пиратом.",
	...
	ANNOUNCE_TRAWL_FULL = "Обильный урожай!",
	...
	COMBAT_QUIT =
	{
		...
		SPIDER_WARRIOR = "Тебе придется умереть!",
	},
	...
	DESCRIBE =
	{
		...
		MINOTAURCHEST = "Заслуженная награда",
		...
		ARMORRUINS = "Древняя броня.",
		RUINS_BAT = "История...",
		RUINSHAT = "Древняя корона.",
		NIGHTMARE_TIMEPIECE =
		{
			CALM = "Очень спокойно.",
			WARN = "Это начинает пугать.",
			WAXING = "Становится все менее спокойно.",
			STEADY = "Он начал успокаиваться.",
			WANING = "Стало спокойно.",
			DAWN = "Тьма отступает.",
        ...
        LICHEN = "Глубоко в пещере",
		CUTLICHEN = "Теперь это не глубоко в пещере.",

		CAVE_BANANA = "Совсем не вкусный...",
		...
		HOUNDSTOOTH="У такие же острые зубы!",
		ARMORSNURTLESHELL="Дом улитки.",
		BAT="Монстры в темноте!",
		BATBAT = "Я стала летучей мышью.",
        ...
        SPORE_TALL = "Лети по ветру",
        SPORE_MEDIUM = "Лети по ветру",
        SPORE_SMALL = "Лети по ветру",
		...
		POWCAKE = "Жизнь прекрасна.",
        CAVE_ENTRANCE = d
        {
            GENERIC="За ним есть спуск.",
            OPEN = "Хорошо, я вытащу все биты.",
        },
        CAVE_EXIT = "Выход из пещер.",
        CAVE_ENTRANCE_OPEN = 
        {
            GENERIC = "Вход",
            OPEN = "Думаю, его нужно открыть.",
        },
        CAVE_EXIT = 
        {
            GENERIC = "Я буду жить здесь?",
            OPEN = "Выход из пещер.",
        },
		MAXWELLPHONOGRAPH = "Эта знакомая музыка...",
		BOOMERANG = "Я играл с этим раньше...",
		...
		ARMOR_SANITY = "Теневая защита",
		ASH =
		{
			GENERIC = "Они увяли.",
			REMAINS_GLOMMERFLOWER = "Это из за телепортации!",
			REMAINS_EYE_BONE = "Это из за телепортации!",
			REMAINS_THINGIE = "Это из за телепортации!",
		},
		AXE = "Это мой топор.",
		BABYBEEFALO = "Хм... Как мило!",
		BACKPACK = "Теперь я могу носить с собой больше предметов.",
		...
		BEARGERVEST = "Невероятно тепло и удобно!",
		ICEPACK = "Мех",
		...
		BEEFALOHAT = "Теперь я похожа на Бифало.",
		BEEFALOWOOL = "Запах бифало",
		BEEHAT = "Раньше у меня был похожий шлем.",
		...
		CACTUS = 
		{
			GENERIC = "У него достаточно острые шипы.",
			PICKED = "Шипы исчезли.",
		},
		CACTUS_MEAT_COOKED = "Странная еда",
		CACTUS_MEAT = "я не хочу пробовать это.",
		CACTUS_FLOWER = "Красивый цветок.",

		COLDFIRE =
		{
			EMBERS = "Я должна добавить немного топлива.",
		...
		CANE = "Раньше я этим почти не пользовалась.",
		CATCOON = "Какой милый кот",
		CATCOONDEN = 
		{
			GENERIC = "В не живет кот.",
			EMPTY = "Он ушел.",
		},
		...
		WATERMELON_SEEDS = "Можно вырастить арбузы",
		CAVE_FERN = "Съедобный папортник",
		CHARCOAL = "Я видела, как горели старые дворцы.",
		...
		COOKEDMONSTERMEAT = "Я никогда раньше не пробовала такой плохой еды.",
		...
		DEADLYFEAST = "Нет, я еще не достигла своего идеала!",
		DEERCLOPS = "Его глаз переполнен ненавистью",
		DEERCLOPS_EYEBALL = "Я вижу отчаяние в твоем глазе.",
		EYEBRELLAHAT =	"Посмотри на небо. Тебе станет лучше.",
		DEPLETED_GRASS =
		{
			GENERIC = "Это просто трава.",
		},
		...
		DIVININGROD =
		{
			...
			GENERIC = "Это устройство, указывает путь к спасению или к затачению",
			HOT = "Под рукой!",
		...
		DRAGON_SCALES = "Я надеюсь, что со мной не будут так обращаться.",
		...
		DRAGONFRUIT = "Еда настоящих драконов.",
		...
		DUG_BERRYBUSH = "Я собираюсь посадить его у себя дома.",
		...
		DURIAN_SEEDS = "Я должна был выбросить это.",
		...
		EVERGREEN =
		{
			...
			BURNT = "Он сгорел.",
			CHOPPED = "Я должyf посадить еще несколько деревьев.",
		...
		FIREHOUND = "Он так разозлился, что сгорел.",
		FIREPIT =
		{
		...
		FISH = "Я люблю рыбу.",
		FISHINGROD = "Порой нужно иметь сильное терпение.",
		...
		FISHTACOS = "Вкусно",
		FISH_COOKED = "Я думала, что сырая пища вкуснее, но эта также хороша.",
		...
		FROG =
		{
			DEAD = "Я укоротила его длинный язык.",
		...
		HOMESIGN = 
		{
			GENERIC = "Тут написано\"Вы находитесь здесь\"",
			UNWRITTEN = "Пусто.",
			BURNT = "Неразборчиво.",
		},
		...
		LIGHTNINGGOAT = 
		{
			...
			CHARGED = "Они стали намного опаснее.",
		},
		LIGHTNINGGOATHORN = "Похожа на молнию",
		...
		LUREPLANT = "Я не настолько наивна.",
		LUREPLANTBULB = "Бутон",
